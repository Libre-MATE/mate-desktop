...
typedef enum {
  ...
  MATE_RR_ERROR_RANDR_ERROR,  /* generic/undescribed error from the underlying
                                 XRR API */
  MATE_RR_ERROR_BOUNDS_ERROR, /* requested bounds of a CRTC are outside the
                                 maximum size */
  MATE_RR_ERROR_CRTC_ASSIGNMENT,    /* could not assign CRTCs to outputs */
  MATE_RR_ERROR_NO_MATCHING_CONFIG, /* none of the saved configurations matched
                                       the current configuration */
} MateRRError;

#define MATE_RR_CONNECTOR_TYPE_PANEL \
  "Panel" /* This is a laptop's built-in LCD */

#define MATE_TYPE_RR_SCREEN (mate_rr_screen_get_type())
#define MATE_RR_SCREEN(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), MATE_TYPE_RR_SCREEN, MateRRScreen))
#define MATE_IS_RR_SCREEN(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), MATE_TYPE_RR_SCREEN))
#define MATE_RR_SCREEN_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), MATE_TYPE_RR_SCREEN, MateRRScreenClass))
#define MATE_IS_RR_SCREEN_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), MATE_TYPE_RR_SCREEN))
#define MATE_RR_SCREEN_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), MATE_TYPE_RR_SCREEN, MateRRScreenClass))
...
gulong mate_rr_output_get_width_mm(MateRROutput *outout);
